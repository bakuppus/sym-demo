...
final class NumberOfRoundsLimitationRuleChecker implements RuleCheckerInterface
{
    public const TYPE = 'number_of_rounds_limitation_checker';
    ...
    public function isEligible(PromotionSubjectInterface $subject, PromotionRuleInterface $rule): bool
    {
        ...
        if (true === ($membershipCard->getNumberOfRounds() < $configuration['limitation_value'])) {
            return true;
        }
