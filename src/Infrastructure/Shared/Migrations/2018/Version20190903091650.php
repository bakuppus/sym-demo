...
class Version20190903091650 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tee_time_bookings ADD CONSTRAINT FK_4C19F5E82A6EF8E FOREIGN KEY (partner_type_id) REFERENCES golf_club_partner_types (id) ON DELETE SET NULL');
